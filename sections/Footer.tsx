        ...
        <div className='grid grid-cols-2'>
          <div className="md:col-span-1">
            ...
            <nav className="space-y-4">
              <a href="#hero" className="block text-slate-400 hover:text-orange-400 transition-colors duration-300 text-base">
                Home
              </a>
              <a href="#experiences" className="block text-slate-400 hover:text-orange-400 transition-colors duration-300 text-base">
                Experience
              </a>
              <a href="#skills" className="block text-slate-400 hover:text-orange-400 transition-colors duration-300 text-base">
                Skills
              </a>
              <a href="#projects" className="block text-slate-400 hover:text-orange-400 transition-colors duration-300 text-base">
                Projects
              </a>
              <a href="#contact" className="block text-slate-400 hover:text-orange-400 transition-colors duration-300 text-base">
                Contact
              </a>
            </nav>
          </div>
