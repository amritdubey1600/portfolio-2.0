...
export const skills: Skill[] = [
  ...
  { name: 'Java', icon: '/icons/java.svg', proficiency: 4 },
  ...
  { name: 'Docker', icon: '/icons/docker.svg', proficiency: 3 },
  ...
  { name: 'SQL', icon: '/icons/sql.svg', proficiency: 4 },
  ...
  { name: 'C', icon: '/icons/c++.svg', proficiency: 3 },
  { name: 'C++', icon: '/icons/c.svg', proficiency: 4 },
