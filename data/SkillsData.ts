...
export const skills: Skill[] = [
  ...
  { name: 'Material UI', icon: '/icons/mui.svg', proficiency: 4 },
  ...
  { name: 'Rest API', icon: '/icons/rest-api.svg', invert: true, proficiency: 5 },
  ...
  { name: 'Python', icon: '/icons/python.svg', proficiency: 3 },
  ...
  { name: 'LangChain', icon: '/icons/langchain.svg', invert: true, proficiency: 3 },
